...
class AxelorViewReference(@NotNull element: PsiElement) : PsiReferenceBase<PsiElement?>(element),
    ...
    override fun multiResolve(incompleteCode: Boolean): Array<ResolveResult> {
        ...
        val properties: List<PsiElement> = XmlUtil.findViewReference(project, viewName)
