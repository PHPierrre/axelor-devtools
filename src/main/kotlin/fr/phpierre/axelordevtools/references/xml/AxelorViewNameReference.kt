...
class AxelorViewNameReference(@NotNull element: PsiElement) : PsiReferenceBase<PsiElement?>(element), PsiPolyVariantReference {
    ...
    override fun multiResolve(incompleteCode: Boolean): Array<ResolveResult> {
        ...
        val properties: List<PsiElement> = XmlUtil.findViewFromName(project, viewName)
